  ...
  return (
    <div className="py-14">
      ...
      <div className="collapse collapse-plus bg-base-100 border border-base-300">
        ...
        <div className="collapse-content text-sm">
          Once you’re logged in, go to the “Popular Skills” section, choose your
          desired skill, and click “View Details.” You can then enroll directly
          from the skill page.
        </div>
      </div>
      ...
      <div className="collapse collapse-plus bg-base-100 border border-base-300">
        ...
        <div className="collapse-content text-sm">
          Yes, our website is fully responsive. You can learn anytime from your
          smartphone, tablet, or computer with the same seamless experience.
        </div>
      </div>
      ...
      <div className="collapse collapse-plus bg-base-100 border border-base-300">
        ...
        <div className="collapse-content text-sm">
          We accept major debit/credit cards, PayPal, and local payment methods
          depending on your region. All transactions are 100% secure.
        </div>
      </div>
